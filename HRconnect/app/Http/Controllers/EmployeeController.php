...
class EmployeeController extends Controller
{
    ...
    public function index()
    {
        $employees = Employee::query()
            ->select('positions.*', 'employees.*', 'departments.*')
    ...
    public function show(string $id)
    {
        ...
        return view('AdminEmployee.ShowEmployee', compact('employee', 'position', 'department', 'employeedoc', 'employeeinformation', 'employeenotify', 'employeeeducation', 'employeeemployment'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($request->file('picture')) {
            $file = $request->file('picture');
            $filename = date('YmdHiu') . $file->getClientOriginalName();
            $file->move(public_path('user_profiles'), $filename);
        ...
        $employeenotify->update([
            ...
            'mobile_no' => $request->input('mobile_no_contact'),
            'address' => $request->input('address_contact'),
        ]);
